...
/**
 * Class Category_Subject_Physics
 *
 * @property \App\Models\Category_Subject_Physics $model
 *
 * @see http://sleepingowladmin.ru/docs/model_configuration_section
 */
class Category_Subject_Physics extends Section
{
    /**
    ...
    public function onEdit($id)
    {
        return AdminForm::panel()->addBody([
            ...
            AdminFormElement::select('parent_category_id', 'Родительская категория')
                ->setModelForOptions(\App\Models\Category_Subject_Physics::class)
