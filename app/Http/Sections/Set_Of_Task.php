 ...
 * Class Set_Of_Task
 *
 * @property \App\Models\Set_Of_Task $model
 *
 * @see http://sleepingowladmin.ru/docs/model_configuration_section
 */
class Set_Of_Task extends Section
{
    /**
...
//        });
        return AdminForm::panel()->addBody([
            ...
            AdminFormElement::select('type', 'Тип', \App\Models\Set_Of_Task_Type::class)->setDisplay('name'),
            AdminSection::getModel(\App\Models\Task::class)
                ->fireDisplay(
