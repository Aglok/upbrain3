 <div class="row">
    ...
    <div class="row">
            ...
            <div class="col-xs-3 t_row">
                <div>
                    <div>
                        <span id="HP" style="position: absolute; left: 5px; top: 6px; z-index: 1; font-size: 9px; font-weight: bold; color: #FFFFFF">{{ $user_class->health_point.'/'.$user_class->health_point }}</span>
                    ...
                    <div>
                        <div>
                            <a href="" target="_blank">
                                    @if($image_char->first())
                                        @if($image_dir == 'man')
                                            <img src="{!! asset($image_char[0]->small_image_m) !!}" title="Рождение" width="120" height="220">
                                        @else
                                            <img src="{!! asset($image_char[0]->small_image_w) !!}" title="Рождение" width="120" height="220">
                                        @endif
                                    @else
                                        <img src="{!! asset($image_dir.'.gif') !!}" title="Силуэт" width="120" height="220">
                                    @endif
                            </a>
                ...
                <div>
                    <img src="http://img.combats.ru/i/misc/slot_bottom0.gif" width="120" height="40">
                </div>
            </div>
            ...
            <div class="col-xs-3 t_row t_margin">
                <ul class="list-unstyled">
                    ...
                    @foreach($skills as $skill)
                            <li>{{ $skill->grade_char }}: <a href="{{URL::route('user_solved_tasks', ['subject' => $subject, 'grade' => $skill->grade_char, 'user_id' => $user_id])}}" title="Опыт: {{ $skill->sum_exp }} | Монет: {{ $skill->sum_gold }}" data-toggle="tooltip" data-placement="top">{{ $skill->sum_tasks }}</a><i></i></li>
                    @endforeach
