    ...
    <div class="faq-container">
        <div class="faq-question" :class="{show: isOpen}" v-for="(item, index) in contents">
            ...
            <v-card class="faq-content" v-show="isOpen">
                ...
                <router-link :to="{ name: 'Table Exam Result', params: { id: item.exam_id }}" class="text-md-center text-xs-center btn-tool black--text">Подробнее</router-link>
            </v-card>
        </div>
    </div>
</template>
