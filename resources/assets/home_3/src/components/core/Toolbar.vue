<template>
  <v-toolbar
    id="core-toolbar" flat prominent style="background: #eee;">
    ...
    <v-toolbar-items>
      <v-flex align-center layout py-2>
        ...
        <v-btn class="default v-btn--simple" dark icon @click.stop="logout()">
          Выйти
        </v-btn>
      </v-flex>
    </v-toolbar-items>
...
export default {
  data: () => ({
    ...
    titles: {'Table Exam': 'Результаты', 'User Profile': 'Ваш профиль'}
  }),

  watch: {
    '$route' (val) {
      this.title = this.titles[val.name]
    }
  },
